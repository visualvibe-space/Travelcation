...
<body>
    ...
    <!-- Destinations Section -->
    <section class="destinations-section" style="position:relative;overflow:hidden;">
        <!-- BG airplane watermark -->
        <div class="bg-plane-watermark bg-plane-tl" style="opacity:0.10;">
            <?= $svg_airplane ?>
        </div>
        <!-- Suitcase right -->
        <div class="suitcase-deco suitcase-right" style="top:40%; right:-25px;">
            <?= $svg_suitcase ?>
        </div>
        <div class="container">
                    ...
                    <?php foreach ($destinations as $dest):
                        ...
                        <a href="destination.php?slug=<?= urlencode($citySlug) ?>" class="destination-card">
                            <div class="destination-img"
                                style="background-image:url('uploads/<?= htmlspecialchars($dest['image']) ?>');">
