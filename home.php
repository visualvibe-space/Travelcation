...
@media (max-width: 576px) {
  ...
  @media (min-width: 769px) {
    .destinationsSwiper .swiper-wrapper {
      display: grid;
      grid-template-columns: repeat(6, 1fr); /* 👈 same as col-lg-2 */
      gap: 24px;
    }
  ...
  @media (max-width: 768px) {
    ...
    .destination-card {
      min-width: 160px; /* 👈 adjust card width */
    }
  }
      ...
      <section class="hero-section" id="home">
          ...
          <div class="hero-background">
              <?php if(count($carousel_images) > 0): ?>
                  ...
                  <?php endforeach; ?>
              <?php else: ?>
                  <div class="bg-slide active" style="background: linear-gradient(135deg, var(--primary-color) 0%, var(--dark-color) 100%);"></div>
              <?php endif; ?>
          </div>
          ...
          ?>
            <div class="swiper-slide">
              <div class="package-card h-100">
                ...
                <div class="card-img-container">
                  <img
                    src="uploads/<?= htmlspecialchars($pkg['image']) ?>"
                ...
                <form method="POST" action="">
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select" name="package_name" required>
                      ...
                      <option value="Change in Personal Particulars">Change in Personal Particulars</option>
                    </select>
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" name="full_name" placeholder="Your Full Name" value="<?= htmlspecialchars($_POST['full_name'] ?? '') ?>" required>
                  </div>
                  <div class="mb-3">
                    <input type="email" class="form-control" name="email" placeholder="Your Email" value="<?= htmlspecialchars($_POST['email'] ?? '') ?>" required>
                  </div>
                  <div class="mb-3">
                    <input type="tel" class="form-control" name="phone" placeholder="Phone Number" value="<?= htmlspecialchars($_POST['phone'] ?? '') ?>" required>
                  </div>
                  <div class="mb-3">
                    <input type="date" class="form-control" name="travel_date" value="<?= htmlspecialchars($_POST['travel_date'] ?? '') ?>" min="<?= date('Y-m-d', strtotime('+1 day')) ?>">
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" name="travelers" placeholder="Number of travelers" value="<?= htmlspecialchars($_POST['travelers'] ?? '') ?>">
                  </div>
                  <div class="mb-3">
                    <textarea class="form-control" name="message" rows="2" placeholder="Additional details..."><?= htmlspecialchars($_POST['message'] ?? '') ?></textarea>
                  </div>
                  <button type="submit" name="submit_service_enquiry" class="btn btn-primary w-100">Submit Enquiry</button>
                </form>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div id="visa-enquiry" class="enquiry-form mt-3" style="display: none;">
                <form method="POST" action="">
                  ...
                  <button type="submit" name="submit_service_enquiry" class="btn btn-success w-100">Submit Enquiry</button>
                </form>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="service-list mb-4">
                <div class="service-item">
                  ...
                  <span><strong>Travel Insurance Assistance</strong> - Comprehensive coverage plans</span>
                </div>
            ...
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <div class="d-flex flex-column gap-3 mt-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div><strong class="me-1">Trusted travel agency since 2012</strong> — over a decade of excellence.</div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div style="min-width: 40px;"><i class="fas fa-check-circle text-success fs-4"></i></div>
                        <div><strong class="me-1">Complete travel solutions under one roof</strong> — packages, hotels, flights, passport, visa.</div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div style="min-width: 40px;"><i class="fas fa-check-circle text-success fs-4"></i></div>
                        <div><strong class="me-1">Customized packages for individuals and groups</strong> — we tailor to your needs.</div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div style="min-width: 40px;"><i class="fas fa-check-circle text-success fs-4"></i></div>
                        <div><strong class="me-1">Competitive pricing and transparent service</strong> — no hidden costs.</div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div style="min-width: 40px;"><i class="fas fa-check-circle text-success fs-4"></i></div>
                        <div><strong class="me-1">Expert support for passport & visa processes</strong> — hassle-free documentation.</div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div style="min-width: 40px;"><i class="fas fa-check-circle text-success fs-4"></i></div>
                        <div><strong class="me-1">Dedicated customer service</strong> for a hassle-free experience.</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6" data-aos="fade-left">
            <img src="uploads/dishant.jpeg" alt="Travelcation Team" class="img-fluid shadow-lg" style="border-radius:100%;height:600px; width:550px;">
...
<section class="quote-section">
    <div class="container">
        ...
        <p class="mt-3 fs-4">Let us turn your travel dreams into reality <i class="fas fa-plane"></i> <i class="fas fa-globe"></i></p>
    </div>
</section>
<!-- Contact Section (IMPROVED) -->
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-7">
                        <div class="contact-form-side">
                            ...
                            <p data-aos="fade-left" data-aos-delay="100">Have questions? We'd love to hear from you. Send us a message and we'll respond as soon as possible.</p>
                            ...
                            <form method="POST" action="" class="contact-form" data-aos="fade-left" data-aos-delay="200">
                                <div class="row">
                                    <div class="col-md-6">
