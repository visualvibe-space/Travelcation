...
<body>
                    ...
                    <div class="col-lg-8">
                        <div class="hero-content fade-in">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php"><i class="fas fa-home me-1"></i>
                                            Home</a></li>
                                    <li class="breadcrumb-item"><a href="all_hotels.php">Hotels</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <?= htmlspecialchars($hotel['hotel_name']) ?></li>
                                </ol>
                            </nav>
    ...
    <!-- Hotel Details -->
    <section id="details" class="hotel-container" style="position:relative;overflow:hidden;">
        <div class="bg-plane-watermark bg-plane-tr" style="opacity:0.10;"><?= $svg_airplane ?></div>
        <div class="suitcase-deco suitcase-left" style="top:40%; left:-25px;"><?= $svg_suitcase ?></div>
        <div class="container">
            <div class="row">
                <!-- Main Content -->
                <div class="col-lg-8">
                    <div class="hotel-main-card">
                        ...
                        <img src="uploads/<?= htmlspecialchars($hotel['image']) ?>"
                            alt="<?= htmlspecialchars($hotel['hotel_name']) ?>" class="hotel-image-main">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="hotel-card">
                                <div class="card-img-container">
                                    ...
                                    <div class="hotel-price-small">₹<?= number_format($hotelItem['price_per_night']) ?>/night
                                    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="message" id="message" rows="3"
                                    placeholder="Any specific requirements..."><?= htmlspecialchars($_POST['message'] ?? '') ?></textarea>
                            </div>
                        </div>
