...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($pkg['title']) ?> | ExploreWorld Travel</title>
    ...
    <div class="container">
        ...
        <ul class="navbar-nav ms-auto">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item active" href="packages.php">Packages</a>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                ...
                <p>Your trusted partner for creating unforgettable travel experiences.</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="contact-info">
                    <li><i class="fas fa-map-marker-alt"></i> 123 Travel Street</li>
        ...
        <div class="copyright">
            <p>&copy; <?= date('Y') ?> ExploreWorld Travel. All rights reserved.</p>
        </div>
    </div>
</footer>
