...
<body>
    ...
    <!-- Package Details -->
    <section id="details" class="package-container" style="margin-top: 2rem; position:relative; overflow:hidden;">
                ...
                <div class="col-lg-8">
                    <div class="package-main-card">
                        ...
                        <img src="uploads/<?= htmlspecialchars($pkg['image']) ?>"
                            alt="<?= htmlspecialchars($pkg['title']) ?>" class="package-image-main">
                        ...
                        <div class="package-content-wrapper">
                            ...
                            <div class="package-stats">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <p><?= htmlspecialchars($pkg['duration']) ?>
                                            <?php if ($pkg['days'] && $pkg['nights']): ?>
                                                <small
                                                    style="font-size: 0.85rem; color: var(--text-light);">(<?= $pkg['days'] ?>D/<?= $pkg['nights'] ?>N)</small>
                                            <?php endif; ?>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="stat-item">
                                    ...
                                    <div class="stat-content">
                                        <h6>Price Type</h6>
                                        <p><?= $pkg['price_type'] == 'starting_from' ? 'Starting From' : 'Fixed Price' ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3 text-muted small">
                        <i class="fas fa-lock me-1"></i> Your information is secure and will not be shared with third
                        parties.
                    </div>
                </div>
            </div>
